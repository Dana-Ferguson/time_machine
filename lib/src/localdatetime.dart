...
/// <param name="period">Period to subtract</param>
/// <returns>The resulting local date and time</returns>
static LocalDateTime Subtract(LocalDateTime localDateTime, Period period) => localDateTime.Minus(period);
...
static Period operator -(LocalDateTime lhs, LocalDateTime rhs) => Period.Between(rhs, lhs);
...
/// <param name="rhs">The date/time to subtract</param>
/// <returns>The result of subtracting one date/time from another.</returns>
static Period Subtract(LocalDateTime lhs, LocalDateTime rhs) => lhs - rhs;
...
Period Minus(LocalDateTime localDateTime) => this - localDateTime;
// #endregion
