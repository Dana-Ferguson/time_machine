...
// the expected results of the standard patterns. We've got an offset of 1 hour though.
  @private static final OffsetDateTime MsdnStandardExample = LocalDateTimePatternTest.MsdnStandardExample.WithOffset(new Offset.fromHours(1));
  @private static final OffsetDateTime MsdnStandardExampleNoMillis = LocalDateTimePatternTest.MsdnStandardExampleNoMillis.WithOffset(new Offset.fromHours(1));
