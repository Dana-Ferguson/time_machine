...
class SpanPatternTest extends PatternTestBase<Time> {
  ...
  void WithCulture() {
    ...
    var text = pattern.format(new Time(minutes: 90));
    expect("1.30", text);
  }
...
/*protected*/ @override Time get defaultTemplate => Time.zero;
  ...
  Data.hm(int hours, int minutes) : this(new Time(hours: hours) + new Time(minutes: minutes));

  Data.hms(int hours, int minutes, int seconds)
      : this(new Time(hours: hours) + new Time(minutes: minutes) + new Time(seconds: seconds));

  Data.dhmsn(int days, int hours, int minutes, int seconds, int nanoseconds)
      : this(new Time(hours: days * 24 + hours) + new Time(minutes: minutes) + new Time(seconds: seconds) + new Time(nanoseconds: nanoseconds));
