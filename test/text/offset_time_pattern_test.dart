...
class OffsetTimePatternTest extends PatternTestBase<OffsetTime> {
  ...
  TestLocalDateTimes.MsdnStandardExample.localTime.withOffset(new Offset.hours(1));
  @private static final OffsetTime MsdnStandardExampleNoMillis =
  TestLocalDateTimes.MsdnStandardExampleNoMillis.localTime.withOffset(new Offset.hours(1));
