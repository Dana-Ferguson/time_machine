...
void GetZoneInterval_Instant_Summer()
{
  ...
  expect(new LocalDateTime.at(2010, 3, 10, 2, 0, 0), interval.isoLocalStart);
  expect(new LocalDateTime.at(2010, 10, 5, 2, 0, 0), interval.isoLocalEnd);
}
...
void GetZoneInterval_Instant_Winter()
{
  ...
  expect(new LocalDateTime.at(2010, 10, 5, 1, 0, 0), interval.isoLocalStart);
  expect(new LocalDateTime.at(2011, 3, 10, 1, 0, 0), interval.isoLocalEnd);
}
...
{
  var early = new LocalDateTime.at(2000, 6, 1, 0, 0, 0);
...
{
  var winter = new LocalDateTime.at(2000, 12, 1, 0, 0, 0);
...
{
  var startOfFirstGap = new LocalDateTime.at(2000, 3, 10, 1, 0, 0);
...
{
  var middleOfFirstGap = new LocalDateTime.at(2000, 3, 10, 1, 30, 0);
...
{
  var endOfFirstGap = new LocalDateTime.at(2000, 3, 10, 2, 0, 0);
...
{
  var firstAmbiguity = new LocalDateTime.at(2000, 10, 5, 1, 0, 0);
...
{
  var firstAmbiguity = new LocalDateTime.at(2000, 10, 5, 1, 30, 0);
  CheckMapping(TestZone.mapLocal(firstAmbiguity), "Summer", "Winter", 2);
}
...
{
  var unambiguousWinter = new LocalDateTime.at(2000, 10, 5, 2, 0, 0);
...
{
  var summer = new LocalDateTime.at(2010, 6, 1, 0, 0, 0);
...
{
  var winter = new LocalDateTime.at(2010, 12, 1, 0, 0, 0);
  CheckMapping(TestZone.mapLocal(winter), "Winter", "Winter", 1);
}
...
{
  var startOfGap = new LocalDateTime.at(2010, 3, 10, 1, 0, 0);
...
{
  var middleOfGap = new LocalDateTime.at(2010, 3, 10, 1, 30, 0);
...
{
  var endOfGap = new LocalDateTime.at(2010, 3, 10, 2, 0, 0);
...
{
  var ambiguity = new LocalDateTime.at(2010, 10, 5, 1, 0, 0);
...
{
  var ambiguity = new LocalDateTime.at(2010, 10, 5, 1, 30, 0);
  CheckMapping(TestZone.mapLocal(ambiguity), "Summer", "Winter", 2);
}
...
{
  var unambiguousWinter = new LocalDateTime.at(2010, 10, 5, 2, 0, 0);
  CheckMapping(TestZone.mapLocal(unambiguousWinter), "Winter", "Winter", 1);
}
