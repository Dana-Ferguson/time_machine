...
void GetOccurrenceForYear_Defaults_Epoch()
{
  ...
  var expected = new LocalDateTime.fromYMDHM(1970, 1, 1, 0, 0).ToLocalInstant();
...
void GetOccurrenceForYear_Year_1971()
{
  ...
  var expected = new LocalDateTime.fromYMDHM(1971, 1, 1, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_Milliseconds()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHMSM(1970, 1, 1, 0, 0, 0, 1).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_WednesdayForward()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHM(1970, 1, 7, 0, 0).ToLocalInstant(); // 1970-01-01 was a Thursday
  expect(expected, actual);
}
...
void GetOccurrenceForYear_WednesdayBackward()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHM(1970, 1, 14, 0, 0).ToLocalInstant(); // 1970-01-15 was a Thursday
  expect(expected, actual);
}
...
void GetOccurrenceForYear_JanMinusTwo()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHM(1970, 1, 30, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_JanFive()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHM(1970, 1, 5, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_Feb()
{
  ...
  var actual = offset.GetOccurrenceForYear(1970);
  var expected = new LocalDateTime.fromYMDHM(1970, 2, 1, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_LastSundayInOctober()
{
  ...
  var expected = new LocalDateTime.fromYMDHM(1996, 10, 27, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_ExactlyFeb29th_LeapYear()
{
  ...
  var expected = new LocalDateTime.fromYMDHM(2012, 2, 29, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
...
void GetOccurrenceForYear_ExactlyFeb29th_NotLeapYear()
{
  ...
  var expected = new LocalDateTime.fromYMDHM(2013, 2, 28, 0, 0).ToLocalInstant(); // For "exact", go to Feb 28th
  expect(expected, actual);
}
...
void GetOccurrenceForYear_AtLeastFeb29th_LeapYear()
{
  ...
  var actual = offset.GetOccurrenceForYear(2012);
  var expected = new LocalDateTime.fromYMDHM(2012, 3, 4, 0, 0).ToLocalInstant(); // March 4th is the first Sunday after 2012-02-29
  expect(expected, actual);
}
...
void GetOccurrenceForYear_AtLeastFeb29th_NotLeapYear()
{
  ZoneYearOffset offset = new ZoneYearOffset(TransitionMode.utc, 2, 29, IsoDayOfWeek.sunday.value,  true, LocalTime.Midnight);
  var actual = offset.GetOccurrenceForYear(2013);
  var expected = new LocalDateTime.fromYMDHM(2013, 3, 3, 0, 0).ToLocalInstant(); // March 3rd is the first Sunday after the non-existent 2013-02-29
  expect(expected, actual);
}
...
void GetOccurrenceForYear_AtMostFeb29th_LeapYear()
{
  ...
  var actual = offset.GetOccurrenceForYear(2012);
  var expected = new LocalDateTime.fromYMDHM(2012, 2, 26, 0, 0).ToLocalInstant(); // Feb 26th is the last Sunday before 2012-02-29
  expect(expected, actual);
}
...
void GetOccurrenceForYear_AtMostFeb29th_NotLeapYear()
{
  ZoneYearOffset offset = new ZoneYearOffset(TransitionMode.utc, 2, 29, IsoDayOfWeek.sunday.value,  false, LocalTime.Midnight);
  var actual = offset.GetOccurrenceForYear(2013);
  var expected = new LocalDateTime.fromYMDHM(2013, 2, 24, 0, 0).ToLocalInstant(); // Feb 24th is the last Sunday is February 2013
  expect(expected, actual);
}
...
void GetOccurrenceForYear_WithAddDay()
{
  ...
  var actual = offset.GetOccurrenceForYear(2013);
  var expected = new LocalDateTime.fromYMDHM(2013, 11, 1, 0, 0).ToLocalInstant();
  expect(expected, actual);
}
